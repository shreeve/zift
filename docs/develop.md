...
```sh
zig build release -Dtarget=x86_64-linux-musl -Dversion=0.10.1-dev
```
...
```sh
zig build release -Dtarget=x86_64-linux-musl  -Dversion=0.10.1-dev
zig build release -Dtarget=aarch64-linux-musl -Dversion=0.10.1-dev
zig build release -Dtarget=x86_64-macos       -Dversion=0.10.1-dev
zig build release -Dtarget=aarch64-macos      -Dversion=0.10.1-dev
```
